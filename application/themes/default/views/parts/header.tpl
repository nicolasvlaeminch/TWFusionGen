			...
			<div class="col-sm-12">
				...
				<nav class="navbar navbar-expand-xl">
					...
					<a href="{$url}" class="navbar-brand" title="Welcome to {$serverName}" data-hasevent="1">
						<span gradient=""></span>
						<span glows=""><img src="https://media.discordapp.net/attachments/1090684462867693660/1090685523611361290/TuWoW-Fente.png?width=1054&height=676" class="logotuwow"></span>
					</a>
					<!-- Brand.End -->
					<!-- Toggler.Start -->
