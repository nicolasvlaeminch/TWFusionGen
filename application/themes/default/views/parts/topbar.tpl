		...
		<div class="row align-items-center">			
			<div class="col-sm-12 col-md-5" social-media>
				...
				<div class="social-media">
					<a href="https://www.facebook.com/profile.php?id=100091337735105" target="_blank" class="social-btn btn-facebook"></a>
					<a href="https://twitter.com/TuWoW_net" target="_blank" class="social-btn btn-twitter"></a>
					<a href="https://www.youtube.com/@Zolack" target="_blank" class="social-btn btn-youtube"></a>
					<a href="https://discord.gg/wxhhYSP7Z7" target="_blank" class="social-btn btn-discord"></a>
				</div>
				<!-- Social media.End -->
			</div>
